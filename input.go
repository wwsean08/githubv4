...
type CreateBranchProtectionRuleInput struct {
	...
	// A unique identifier for the client performing the mutation. (Optional.)
	ClientMutationID *String `json:"clientMutationId,omitempty"`
	// Can the last person to push to this branch approve the PR (Optional.)
	RequireLastPushApproval *Boolean `json:"requireLastPushApproval"`
	// Is the branch read-only preventing all pushes to it (Optional.)
	LockBranch *Boolean `json:"lockBranch"`
}
